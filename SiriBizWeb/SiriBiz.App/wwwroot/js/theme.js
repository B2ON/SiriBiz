    ...
    var e = {
        ...
        stickyNavbar: function () {
            ...
            if (null != t) {
                ...
                e.contains("navbar-floating") && e.contains("navbar-dark") ? window.addEventListener("scroll", function (e) {
                    ...
                    500 < e.currentTarget.pageYOffset ? (document.body.style.paddingTop = a + "px",
                        ...
                        if (n.files && n.files[0]) {
                            ...
                            e.onload = function (e) {
                                ...
                                if (o.innerHTML = a,
                                    ...
                                    r.src = t,
                                        r.onload = function () {
                                            s.className = "cs-file-drop-preview",
                                                s.innerHTML = '<img class="img-thumbnail rounded" src="' + r.src + '" alt="' + a + '">',
                                                console.log(this.width)
                                        }
                                } else
                                    t.startsWith("data:video") ? (s.innerHTML = "",
                                        s.className = "",
                                        s.className = "cs-file-drop-icon siribiz-video") : (s.innerHTML = "",
                                            s.className = "",
                                            s.className = "cs-file-drop-icon siribiz-file-text")
                            }
                                ,
        ...
        inputFormatter: function () {
            ...
            if (0 !== e.length)
                for (var t = 0; t < e.length; t++) {
                    ...
                    switch (r = void 0 !== r ? r.split(" ").map(Number) : "",
                    n = void 0 !== n ? n : " ",
                    a) {
                        case "card":
                            new Cleave(e[t], {
        ...
        offcanvas: function () {
            for (var e = document.querySelectorAll('[data-toggle="offcanvas"]'), t = 0; t < e.length; t++)
                e[t].addEventListener("click", function (e) {
                    e.preventDefault(),
                        document.getElementById(e.currentTarget.dataset.offcanvasId).classList.toggle("show")
                })
        },
        tooltips: function () {
        ...
        carousel: function () {
            !function (e, t, a) {
                ...
                var a, r = {
                    container: t,
                    controlsText: ['<i class="siribiz-arrow-left"></i>', '<i class="siribiz-arrow-right"></i>'],
                    navPosition: "top",
            ...
            if (o.length)
                for (var e = function (a) {
                    ...
                    function t(e) {
                        ...
                        this.classList.add("active"),
                            o[a].querySelector(this.getAttribute("href")).classList.add("active")
                    }
                }, t = 0; t < o.length; t++)
                    e(t)
        },
        ...
        charts: function () {
            ...
            if (0 !== e.length || 0 !== t.length || 0 !== s.length) {
                var c, a = document.head || document.getElementsByTagName("head")[0], l = document.createElement("style");
                a.appendChild(l);
                for (var r = 0; r < e.length; r++) {
                    var n = JSON.parse(e[r].dataset.lineChart)
                        ...
                        , u = void 0;
                    if (e[r].classList.add("cz-line-chart-" + r),
                        null != d) {
                        u = JSON.parse(d);
                ...
                for (var b = function (e) {
                    var t = JSON.parse(s[e].dataset.pieChart)
                        ...
                        , r = void 0;
                    if (s[e].classList.add("cz-pie-chart-" + e),
                        null != a) {
                        r = JSON.parse(a);
            ...
            for (var o = document.querySelectorAll(".cs-range-slider"), e = function (e) {
                ...
                noUiSlider.create(t, {
                    ...
                    t.noUiSlider.on("update", function (e, t) {
                        var a = e[t];
                        a = a.replace(/\D/g, ""),
                            t ? n.value = Math.round(a) : r.value = Math.round(a)
                    }),
                    r.addEventListener("change", function () {
                    ...
                    e[t].addEventListener("change", function () {
                        ...
                        if (this.checked)
                            ...
                            for (var a = 0; a < e.length; a++)
                                e[a].checked = !1,
                                    e[a].dataset.checkboxToggleClass && document.querySelector(e[a].dataset.target).classList.remove(e[a].dataset.checkboxToggleClass)
                    })
        },
        parallax: function () {
